...
const onClearCartItems = ()=>{
  dispath(setClearCartItems())
}
  return (
    <>
      <div
        className={`fixed top- left-0 right-0 bottom-0 blur-effect-theme w-full h-screen opacity-100 z-[250] ${
          ifCartState
      ...
      >
        ...
        >
          ...
          {cartItems.length === 0 ? (
            ...
            <div>
              <div className='flex items-start justify-start flex-col  gap-y-7 lg:gap-y-5 overflow-y-scroll h-[81vh] scroll-hidden'>
