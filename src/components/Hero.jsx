  ...
  return (
    <>
      <div className='relative h-auto w-auto flex flex-col'>
        ...
        <div className='relative opacity-100 z-20 grid item-center justify-item-center nike-container'>
          <div className='grid items-center justify-items-center mt-28 md:mt-24'>
            ...
            <button type='button' className='button-theme bg-slate-200 shadow-slate rounded-xl my-5'>{btntext}</button>
            <div className='grid items-center gap-5 absolute top-[33vh] lg:top-[27vh] left-[11%] xl:left-0 w-auto h-auto'>
              {videos?.map((val, i) =>(
